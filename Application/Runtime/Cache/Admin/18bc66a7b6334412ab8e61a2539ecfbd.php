...
<body>
    ...
    <div class="sidebar">
            ...
            <?php if(!empty($menus)): if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(is_array($vo)): $index = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($index % 2 );++$index; if(($index) == "1"): if(!empty($v["group"])): ?><p><?php echo ($v["group"]); ?></p>
                            ...
                            <li><a class="menu<?php echo ($v["option"]); ?>" href="/index.php/Admin/Order/../<?php echo ($v["url"]); ?>.html"><?php echo ($v["title"]); ?></a></li>
                            <?php else: ?>
                            <li><a class="menu<?php echo ($v["option"]); ?>" href="/index.php/Admin/Order/../<?php echo ($v["url"]); ?>.html"><?php echo ($v["title"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; endif; ?>
    ...
    <div class="content_list">
        <table>
            ...
            <tbody>
                <?php if(!empty($orderlist)): if(is_array($orderlist)): $i = 0; $__LIST__ = $orderlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i%2 == 0): ?><tr>
                                <?php else: ?>
                        ...
                        <td><?php echo ($vo["name"]); ?>　<?php echo ($vo["num"]); ?></td>
                        <td><?php echo ($vo["total_fee"]); ?></td>
                        <td><?php echo ($vo["create_time"]); ?></td>
                        <td><?php echo ($vo["update_time"]); ?></td>
                       <!--  <td>
                            <?php if(($vo["status"]) == "0"): ?><a href="/index.php/Admin/Order/dealed/id/<?php echo ($vo["id"]); ?>" class="confirm ajax-get">确认处理</a>
                                <?php else: ?>
                                <a href="/index.php/Admin/Order/dealing/id/<?php echo ($vo["id"]); ?>" class="confirm ajax-get">恢复处理</a><?php endif; ?>
                            <span class="edit_option" data-href="<?php echo U('adminedit?uid='.$vo['uid']);?>" data-title="编辑管理员">编辑</span>
                            <a href="/index.php/Admin/Order/delete/id/<?php echo ($vo["id"]); ?>" class="confirm ajax-get">删除</a>
                        </td> -->
...
$("#login_out").click(function() {
    ...
    $.post("/index.php/Admin/Order/../Login/loginout", "", function(res) {
        location.reload();
