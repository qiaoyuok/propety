        ...
        <form class="layui-form" action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sort" value="0" required lay-verify="required" placeholder="请输入排序序号" autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="url" required lay-verify="required" placeholder="菜单链接地址" autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="parent_id" lay-verify="required">
                        ...
                        <?php if(is_array($parent_menus)): $i = 0; $__LIST__ = $parent_menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="group" placeholder="分组名称" autocomplete="off" class="layui-input">
                </div>
...
layui.use(['form','layer'], function() {
    ...
    form.on('submit(submit)', function(data) {
        ...
        $.post("/index.php/Admin/System/add", data.field, function (res) {
        	console.log(res)
        	if(res.status == 1){
