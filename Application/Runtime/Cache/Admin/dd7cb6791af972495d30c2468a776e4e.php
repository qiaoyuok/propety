        ...
        <form class="layui-form" action="">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="title" required lay-verify="required" value="<?php echo ($newsdetail['title']); ?>" placeholder="请输入新闻标题" autocomplete="title" class="layui-input">
                    <input type="text" name="id" value="<?php echo ($newsdetail['id']); ?>" hidden>
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="author" placeholder="请输入作者名称" value="<?php echo ($newsdetail['author']); ?>" autocomplete="address" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    ...
                    <a class="layui-btn layui-btn-primary" onclick="javascript:;window.location.href='/index.php/Admin/System/news'">返回</a>
                </div>
            </div>
        </form>
    </div>
   ...
   <script type="text/javascript">
    ...
    layui.use(['layer', 'form'], function() {
        ...
        form.on('submit(confirm)', function(data) {
            ...
            $.post("/index.php/Admin/System/editnews", data.field, function(res) {
