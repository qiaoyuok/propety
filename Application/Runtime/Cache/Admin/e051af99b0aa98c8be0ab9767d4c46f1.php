...
<body>
    ...
    <div class="main_option">
        <ul>
            <li onclick="javascript:;window.location.href='/index.php/Admin/System/addnews'">添加新闻</li>
            <li class="batch" data-href="<?php echo U('shownews');?>">显示</li>
            <li class="batch" data-href="<?php echo U('hidenews');?>">隐藏</li>
            <li class="batch" data-href="<?php echo U('delnews');?>">删除</li>
    ...
    <div class="content_list">
        <table>
            ...
            <tbody>
                <?php if(!empty($newslist)): if(is_array($newslist)): $i = 0; $__LIST__ = $newslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i%2 == 0): ?><tr>
                                <?php else: ?>
                                <tr class="addback"><?php endif; ?>
                        <td>
                            <input class="ids" type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>"><?php echo ($i); ?></td>               
                        <td><?php echo ($vo["title"]); ?></td>
                        <td><?php if(empty($vo["author"])): ?>迭名
                            <?php else: ?>
                            <?php echo ($vo["author"]); endif; ?></td>
                        <td><?php echo ($vo["create_time"]); ?></td>
                        <td><?php echo ($vo["update_time"]); ?></td>
                        <td><?php if(($vo["status"]) == "1"): ?><b style="color: green;">显示</b>
                                    <?php else: ?><b style="color: red;">隐藏</b><?php endif; ?></td>
                        <td>
                            <?php if(($vo["status"]) == "0"): ?><a href="/index.php/Admin/System/shownews/id/<?php echo ($vo["id"]); ?>" class="confirm ajax-get">显示</a>
                                <?php else: ?>
                                <a href="/index.php/Admin/System/hidenews/id/<?php echo ($vo["id"]); ?>" class="confirm ajax-get">隐藏</a><?php endif; ?>
                            <a href="/index.php/Admin/System/editnews/id/<?php echo ($vo["id"]); ?>">编辑</a>
                            <a href="/index.php/Admin/System/delnews/id/<?php echo ($vo["id"]); ?>" class="confirm ajax-get">删除</a>
                        </td>
