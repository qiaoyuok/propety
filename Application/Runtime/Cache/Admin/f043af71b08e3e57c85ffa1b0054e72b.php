...
<body>
    ...
    <div class="sidebar">
            ...
            <?php if(!empty($menus)): if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(is_array($vo)): $index = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($index % 2 );++$index; if(($index) == "1"): if(!empty($v["group"])): ?><p><?php echo ($v["group"]); ?></p>
                            ...
                            <li><a class="menu<?php echo ($v["option"]); ?>" href="/index.php/Admin/Fee/../<?php echo ($v["url"]); ?>.html"><?php echo ($v["title"]); ?></a></li>
                            <?php else: ?>
                            <li><a class="menu<?php echo ($v["option"]); ?>" href="/index.php/Admin/Fee/../<?php echo ($v["url"]); ?>.html"><?php echo ($v["title"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; endif; ?>
    ...
    <div class="content_list">
        <table>
            ...
            <tbody>
                <?php if(!empty($feelists)): if(is_array($feelists)): $i = 0; $__LIST__ = $feelists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i%2 == 0): ?><tr>
                                <?php else: ?>
                        ...
                        <td>
                            <?php if(($vo["rstatus"]) == "1"): ?>房东无需缴费
                                <?php elseif($vo["rfee_status"] == 0): ?>
                                <b style="color: red;"><?php echo ($vo["rfee"]); ?>￥　待缴纳</b>
                                <?php else: ?><b style="color: green;">完成缴费</b><?php endif; ?>
                        </td>
                        <td>
                            <?php if(($vo["pofee_status"]) == "0"): ?><b style="color: red;"><?php echo ($vo["pofee"]); ?>￥　待缴纳</b>
                                <?php else: ?><b style="color: green;">完成缴费</b><?php endif; ?>
                        </td>
                        <td>
                            <span class="edit_option" data-href="<?php echo U('feedetail?id='.$vo['id']);?>" data-title="缴费详情">缴费详情</span>
                        </td>
...
$("#login_out").click(function() {
    ...
    $.post("/index.php/Admin/Fee/../Login/loginout", "", function(res) {
        location.reload();
